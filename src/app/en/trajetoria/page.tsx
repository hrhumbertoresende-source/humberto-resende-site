...
export const metadata: Metadata = {
  title: "Humberto Resende | Architect, Scenographer, and Creative Consultant in São Paulo",
  description:
    "Discover the journey of Humberto Resende, an architect specialized in architecture, scenography, and lighting, with over 15 years of experience between São Paulo and Mato Grosso.",
};

export default async function TrajetoriaPageEn() {
  const content = await getTrajetoriaContent("en");
    ...
    <div className="px-6 py-16 md:px-16 md:py-24">
      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-[minmax(0,280px)_1fr] md:gap-16">
        ...
        <div className="max-w-2xl space-y-8 text-base text-neutral-500">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-wide text-neutral-900">Tools</p>
            <p className="mt-2">{content.ferramentas}</p>
          </div>
          <div>
            <p className="text-xs font-bold uppercase tracking-wide text-neutral-900">International language training</p>
